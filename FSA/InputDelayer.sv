...
module InputDelayer(	
  ...
  always @(posedge clock) begin	
    if(reset)begin
      ...
      out_delay_r_1_sign    <= 'd0;
      out_delay_r_1_exp   <= 'd0;
      out_delay_r_1_mantissa    <= 'd0;
      out_delay_r_2_sign    <= 'd0;
      out_delay_r_2_exp   <= 'd0;
      out_delay_r_2_mantissa    <= 'd0;
      out_delay_r_3_sign    <= 'd0;
      out_delay_r_3_exp   <= 'd0;
      out_delay_r_3_mantissa    <= 'd0;
      out_delay_r_4_sign    <= 'd0;
      out_delay_r_4_exp   <= 'd0;
      out_delay_r_4_mantissa    <= 'd0;
      out_delay_r_5_sign    <= 'd0;
      out_delay_r_5_exp   <= 'd0;
      out_delay_r_5_mantissa    <= 'd0;
      out_delay_r_6_sign    <= 'd0;
      out_delay_r_6_exp   <= 'd0;
      out_delay_r_6_mantissa    <= 'd0;
      out_delay_r_7_sign    <= 'd0;
      out_delay_r_7_exp   <= 'd0;
      out_delay_r_7_mantissa    <= 'd0;
      out_delay_r_8_sign    <= 'd0;
      out_delay_r_8_exp   <= 'd0;
      out_delay_r_8_mantissa    <= 'd0;
      out_delay_r_9_sign    <= 'd0;
      out_delay_r_9_exp   <= 'd0;
      out_delay_r_9_mantissa    <= 'd0;
      out_delay_r_10_sign   <= 'd0;
      out_delay_r_10_exp    <= 'd0;
      out_delay_r_10_mantissa   <= 'd0;
      out_delay_r_11_sign   <= 'd0;
      out_delay_r_11_exp    <= 'd0;
      out_delay_r_11_mantissa   <= 'd0;
      out_delay_r_12_sign   <= 'd0;
      out_delay_r_12_exp    <= 'd0;
      out_delay_r_12_mantissa   <= 'd0;
      out_delay_r_13_sign   <= 'd0;
      out_delay_r_13_exp    <= 'd0;
      out_delay_r_13_mantissa   <= 'd0;
      out_delay_r_14_sign   <= 'd0;
      out_delay_r_14_exp    <= 'd0;
      out_delay_r_14_mantissa   <= 'd0;
      out_delay_r_15_sign   <= 'd0;
      out_delay_r_15_exp    <= 'd0;
      out_delay_r_15_mantissa   <= 'd0;
      out_delay_r_16_sign   <= 'd0;
      out_delay_r_16_exp    <= 'd0;
      out_delay_r_16_mantissa   <= 'd0;
      out_delay_r_17_sign   <= 'd0;
      out_delay_r_17_exp    <= 'd0;
      out_delay_r_17_mantissa   <= 'd0;
      out_delay_r_18_sign   <= 'd0;
      out_delay_r_18_exp    <= 'd0;
      out_delay_r_18_mantissa   <= 'd0;
      out_delay_r_19_sign   <= 'd0;
      out_delay_r_19_exp    <= 'd0;
      out_delay_r_19_mantissa   <= 'd0;
      out_delay_r_20_sign   <= 'd0;
      out_delay_r_20_exp    <= 'd0;
      out_delay_r_20_mantissa   <= 'd0;
      out_delay_r_21_sign   <= 'd0;
      out_delay_r_21_exp    <= 'd0;
      out_delay_r_21_mantissa   <= 'd0;
      out_delay_r_22_sign   <= 'd0;
      out_delay_r_22_exp    <= 'd0;
      out_delay_r_22_mantissa   <= 'd0;
      out_delay_r_23_sign   <= 'd0;
      out_delay_r_23_exp    <= 'd0;
      out_delay_r_23_mantissa   <= 'd0;
      out_delay_r_24_sign   <= 'd0;
      out_delay_r_24_exp    <= 'd0;
      out_delay_r_24_mantissa   <= 'd0;
      out_delay_r_25_sign   <= 'd0;
      out_delay_r_25_exp    <= 'd0;
      out_delay_r_25_mantissa   <= 'd0;
      out_delay_r_26_sign   <= 'd0;
      out_delay_r_26_exp    <= 'd0;
      out_delay_r_26_mantissa   <= 'd0;
      out_delay_r_27_sign   <= 'd0;
      out_delay_r_27_exp    <= 'd0;
      out_delay_r_27_mantissa   <= 'd0;
      out_delay_r_28_sign   <= 'd0;
      out_delay_r_28_exp    <= 'd0;
      out_delay_r_28_mantissa   <= 'd0;
      out_delay_r_29_sign   <= 'd0;
      out_delay_r_29_exp    <= 'd0;
      out_delay_r_29_mantissa   <= 'd0;
      out_delay_r_30_sign   <= 'd0;
      out_delay_r_30_exp    <= 'd0;
      out_delay_r_30_mantissa   <= 'd0;
      out_delay_r_31_sign   <= 'd0;
      out_delay_r_31_exp    <= 'd0;
      out_delay_r_31_mantissa   <= 'd0;
      out_delay_r_32_sign   <= 'd0;
      out_delay_r_32_exp    <= 'd0;
      out_delay_r_32_mantissa   <= 'd0;
      out_delay_r_33_sign   <= 'd0;
      out_delay_r_33_exp    <= 'd0;
      out_delay_r_33_mantissa   <= 'd0;
      out_delay_r_34_sign   <= 'd0;
      out_delay_r_34_exp    <= 'd0;
      out_delay_r_34_mantissa   <= 'd0;
      out_delay_r_35_sign   <= 'd0;
      out_delay_r_35_exp    <= 'd0;
      out_delay_r_35_mantissa   <= 'd0;
      out_delay_r_36_sign   <= 'd0;
      out_delay_r_36_exp    <= 'd0;
      out_delay_r_36_mantissa   <= 'd0;
      out_delay_r_37_sign   <= 'd0;
      out_delay_r_37_exp    <= 'd0;
      out_delay_r_37_mantissa   <= 'd0;
      out_delay_r_38_sign   <= 'd0;
      out_delay_r_38_exp    <= 'd0;
      out_delay_r_38_mantissa   <= 'd0;
      out_delay_r_39_sign   <= 'd0;
      out_delay_r_39_exp    <= 'd0;
      out_delay_r_39_mantissa   <= 'd0;
      out_delay_r_40_sign   <= 'd0;
      out_delay_r_40_exp    <= 'd0;
      out_delay_r_40_mantissa   <= 'd0;
      out_delay_r_41_sign   <= 'd0;
      out_delay_r_41_exp    <= 'd0;
      out_delay_r_41_mantissa   <= 'd0;
      out_delay_r_42_sign   <= 'd0;
      out_delay_r_42_exp    <= 'd0;
      out_delay_r_42_mantissa   <= 'd0;
      out_delay_r_43_sign   <= 'd0;
      out_delay_r_43_exp    <= 'd0;
      out_delay_r_43_mantissa   <= 'd0;
      out_delay_r_44_sign   <= 'd0;
      out_delay_r_44_exp    <= 'd0;
      out_delay_r_44_mantissa   <= 'd0;
      out_delay_r_45_sign   <= 'd0;
      out_delay_r_45_exp    <= 'd0;
      out_delay_r_45_mantissa   <= 'd0;
      out_delay_r_46_sign   <= 'd0;
      out_delay_r_46_exp    <= 'd0;
      out_delay_r_46_mantissa   <= 'd0;
      out_delay_r_47_sign   <= 'd0;
      out_delay_r_47_exp    <= 'd0;
      out_delay_r_47_mantissa   <= 'd0;
      out_delay_r_48_sign   <= 'd0;
      out_delay_r_48_exp    <= 'd0;
      out_delay_r_48_mantissa   <= 'd0;
      out_delay_r_49_sign   <= 'd0;
      out_delay_r_49_exp    <= 'd0;
      out_delay_r_49_mantissa   <= 'd0;
      out_delay_r_50_sign   <= 'd0;
      out_delay_r_50_exp    <= 'd0;
      out_delay_r_50_mantissa   <= 'd0;
      out_delay_r_51_sign   <= 'd0;
      out_delay_r_51_exp    <= 'd0;
      out_delay_r_51_mantissa   <= 'd0;
      out_delay_r_52_sign   <= 'd0;
      out_delay_r_52_exp    <= 'd0;
      out_delay_r_52_mantissa   <= 'd0;
      out_delay_r_53_sign   <= 'd0;
      out_delay_r_53_exp    <= 'd0;
      out_delay_r_53_mantissa   <= 'd0;
      out_delay_r_54_sign   <= 'd0;
      out_delay_r_54_exp    <= 'd0;
      out_delay_r_54_mantissa   <= 'd0;
      out_delay_r_55_sign   <= 'd0;
      out_delay_r_55_exp    <= 'd0;
      out_delay_r_55_mantissa   <= 'd0;
      out_delay_r_56_sign   <= 'd0;
      out_delay_r_56_exp    <= 'd0;
      out_delay_r_56_mantissa   <= 'd0;
      out_delay_r_57_sign   <= 'd0;
      out_delay_r_57_exp    <= 'd0;
      out_delay_r_57_mantissa   <= 'd0;
      out_delay_r_58_sign   <= 'd0;
      out_delay_r_58_exp    <= 'd0;
      out_delay_r_58_mantissa   <= 'd0;
      out_delay_r_59_sign   <= 'd0;
      out_delay_r_59_exp    <= 'd0;
      out_delay_r_59_mantissa   <= 'd0;
      out_delay_r_60_sign   <= 'd0;
      out_delay_r_60_exp    <= 'd0;
      out_delay_r_60_mantissa   <= 'd0;
      out_delay_r_61_sign   <= 'd0;
      out_delay_r_61_exp    <= 'd0;
      out_delay_r_61_mantissa   <= 'd0;
      out_delay_r_62_sign   <= 'd0;
      out_delay_r_62_exp    <= 'd0;
      out_delay_r_62_mantissa   <= 'd0;
      out_delay_r_63_sign   <= 'd0;
      out_delay_r_63_exp    <= 'd0;
      out_delay_r_63_mantissa   <= 'd0;
      out_delay_r_64_sign   <= 'd0;
      out_delay_r_64_exp    <= 'd0;
      out_delay_r_64_mantissa   <= 'd0;
      out_delay_r_65_sign   <= 'd0;
      out_delay_r_65_exp    <= 'd0;
      out_delay_r_65_mantissa   <= 'd0;
      out_delay_r_66_sign   <= 'd0;
      out_delay_r_66_exp    <= 'd0;
      out_delay_r_66_mantissa   <= 'd0;
      out_delay_r_67_sign   <= 'd0;
      out_delay_r_67_exp    <= 'd0;
      out_delay_r_67_mantissa   <= 'd0;
      out_delay_r_68_sign   <= 'd0;
      out_delay_r_68_exp    <= 'd0;
      out_delay_r_68_mantissa   <= 'd0;
      out_delay_r_69_sign   <= 'd0;
      out_delay_r_69_exp    <= 'd0;
      out_delay_r_69_mantissa   <= 'd0;
      out_delay_r_70_sign   <= 'd0;
      out_delay_r_70_exp    <= 'd0;
      out_delay_r_70_mantissa   <= 'd0;
      out_delay_r_71_sign   <= 'd0;
      out_delay_r_71_exp    <= 'd0;
      out_delay_r_71_mantissa   <= 'd0;
      out_delay_r_72_sign   <= 'd0;
      out_delay_r_72_exp    <= 'd0;
      out_delay_r_72_mantissa   <= 'd0;
      out_delay_r_73_sign   <= 'd0;
      out_delay_r_73_exp    <= 'd0;
      out_delay_r_73_mantissa   <= 'd0;
      out_delay_r_74_sign   <= 'd0;
      out_delay_r_74_exp    <= 'd0;
      out_delay_r_74_mantissa   <= 'd0;
      out_delay_r_75_sign   <= 'd0;
      out_delay_r_75_exp    <= 'd0;
      out_delay_r_75_mantissa   <= 'd0;
      out_delay_r_76_sign   <= 'd0;
      out_delay_r_76_exp    <= 'd0;
      out_delay_r_76_mantissa   <= 'd0;
      out_delay_r_77_sign   <= 'd0;
      out_delay_r_77_exp    <= 'd0;
      out_delay_r_77_mantissa   <= 'd0;
      out_delay_r_78_sign   <= 'd0;
      out_delay_r_78_exp    <= 'd0;
      out_delay_r_78_mantissa   <= 'd0;
      out_delay_r_79_sign   <= 'd0;
      out_delay_r_79_exp    <= 'd0;
      out_delay_r_79_mantissa   <= 'd0;
      out_delay_r_80_sign   <= 'd0;
      out_delay_r_80_exp    <= 'd0;
      out_delay_r_80_mantissa   <= 'd0;
      out_delay_r_81_sign   <= 'd0;
      out_delay_r_81_exp    <= 'd0;
      out_delay_r_81_mantissa   <= 'd0;
      out_delay_r_82_sign   <= 'd0;
      out_delay_r_82_exp    <= 'd0;
      out_delay_r_82_mantissa   <= 'd0;
      out_delay_r_83_sign   <= 'd0;
      out_delay_r_83_exp    <= 'd0;
      out_delay_r_83_mantissa   <= 'd0;
      out_delay_r_84_sign   <= 'd0;
      out_delay_r_84_exp    <= 'd0;
      out_delay_r_84_mantissa   <= 'd0;
      out_delay_r_85_sign   <= 'd0;
      out_delay_r_85_exp    <= 'd0;
      out_delay_r_85_mantissa   <= 'd0;
      out_delay_r_86_sign   <= 'd0;
      out_delay_r_86_exp    <= 'd0;
      out_delay_r_86_mantissa   <= 'd0;
      out_delay_r_87_sign   <= 'd0;
      out_delay_r_87_exp    <= 'd0;
      out_delay_r_87_mantissa   <= 'd0;
      out_delay_r_88_sign   <= 'd0;
      out_delay_r_88_exp    <= 'd0;
      out_delay_r_88_mantissa   <= 'd0;
      out_delay_r_89_sign   <= 'd0;
      out_delay_r_89_exp    <= 'd0;
      out_delay_r_89_mantissa   <= 'd0;
      out_delay_r_90_sign   <= 'd0;
      out_delay_r_90_exp    <= 'd0;
      out_delay_r_90_mantissa   <= 'd0;
      out_delay_r_91_sign   <= 'd0;
      out_delay_r_91_exp    <= 'd0;
      out_delay_r_91_mantissa   <= 'd0;
      out_delay_r_92_sign   <= 'd0;
      out_delay_r_92_exp    <= 'd0;
      out_delay_r_92_mantissa   <= 'd0;
      out_delay_r_93_sign   <= 'd0;
      out_delay_r_93_exp    <= 'd0;
      out_delay_r_93_mantissa   <= 'd0;
      out_delay_r_94_sign   <= 'd0;
      out_delay_r_94_exp    <= 'd0;
      out_delay_r_94_mantissa   <= 'd0;
      out_delay_r_95_sign   <= 'd0;
      out_delay_r_95_exp    <= 'd0;
      out_delay_r_95_mantissa   <= 'd0;
      out_delay_r_96_sign   <= 'd0;
      out_delay_r_96_exp    <= 'd0;
      out_delay_r_96_mantissa   <= 'd0;
      out_delay_r_97_sign   <= 'd0;
      out_delay_r_97_exp    <= 'd0;
      out_delay_r_97_mantissa   <= 'd0;
      out_delay_r_98_sign   <= 'd0;
      out_delay_r_98_exp    <= 'd0;
      out_delay_r_98_mantissa   <= 'd0;
      out_delay_r_99_sign   <= 'd0;
      out_delay_r_99_exp    <= 'd0;
      out_delay_r_99_mantissa   <= 'd0;
      out_delay_r_100_sign    <= 'd0;
      out_delay_r_100_exp   <= 'd0;
      out_delay_r_100_mantissa    <= 'd0;
      out_delay_r_101_sign    <= 'd0;
      out_delay_r_101_exp   <= 'd0;
      out_delay_r_101_mantissa    <= 'd0;
      out_delay_r_102_sign    <= 'd0;
      out_delay_r_102_exp   <= 'd0;
      out_delay_r_102_mantissa    <= 'd0;
      out_delay_r_103_sign    <= 'd0;
      out_delay_r_103_exp   <= 'd0;
      out_delay_r_103_mantissa    <= 'd0;
      out_delay_r_104_sign    <= 'd0;
      out_delay_r_104_exp   <= 'd0;
      out_delay_r_104_mantissa    <= 'd0;
      out_delay_r_105_sign    <= 'd0;
      out_delay_r_105_exp   <= 'd0;
      out_delay_r_105_mantissa    <= 'd0;
      out_delay_r_106_sign    <= 'd0;
      out_delay_r_106_exp   <= 'd0;
      out_delay_r_106_mantissa    <= 'd0;
      out_delay_r_107_sign    <= 'd0;
      out_delay_r_107_exp   <= 'd0;
      out_delay_r_107_mantissa    <= 'd0;
      out_delay_r_108_sign    <= 'd0;
      out_delay_r_108_exp   <= 'd0;
      out_delay_r_108_mantissa    <= 'd0;
      out_delay_r_109_sign    <= 'd0;
      out_delay_r_109_exp   <= 'd0;
      out_delay_r_109_mantissa    <= 'd0;
      out_delay_r_110_sign    <= 'd0;
      out_delay_r_110_exp   <= 'd0;
      out_delay_r_110_mantissa    <= 'd0;
      out_delay_r_111_sign    <= 'd0;
      out_delay_r_111_exp   <= 'd0;
      out_delay_r_111_mantissa    <= 'd0;
      out_delay_r_112_sign    <= 'd0;
      out_delay_r_112_exp   <= 'd0;
      out_delay_r_112_mantissa    <= 'd0;
      out_delay_r_113_sign    <= 'd0;
      out_delay_r_113_exp   <= 'd0;
      out_delay_r_113_mantissa    <= 'd0;
      out_delay_r_114_sign    <= 'd0;
      out_delay_r_114_exp   <= 'd0;
      out_delay_r_114_mantissa    <= 'd0;
      out_delay_r_115_sign    <= 'd0;
      out_delay_r_115_exp   <= 'd0;
      out_delay_r_115_mantissa    <= 'd0;
      out_delay_r_116_sign    <= 'd0;
      out_delay_r_116_exp   <= 'd0;
      out_delay_r_116_mantissa    <= 'd0;
      out_delay_r_117_sign    <= 'd0;
      out_delay_r_117_exp   <= 'd0;
      out_delay_r_117_mantissa    <= 'd0;
      out_delay_r_118_sign    <= 'd0;
      out_delay_r_118_exp   <= 'd0;
      out_delay_r_118_mantissa    <= 'd0;
      out_delay_r_119_sign    <= 'd0;
      out_delay_r_119_exp   <= 'd0;
      out_delay_r_119_mantissa    <= 'd0;
