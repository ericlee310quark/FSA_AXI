...
module TLAToBeat_SerialRAM_a64d64s8k8z8c(	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
  ...
  wire [260:0] _tail_beats1_decode_T = 261'h3F << _q_io_deq_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:243:71, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  reg  [3:0]   head_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire         head = head_counter == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  wire [3:0]   tail_beats1 = _q_io_deq_bits_opcode[2] ? 4'h0 : ~(_tail_beats1_decode_T[5:2]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
  reg  [3:0]   tail_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  ...
  wire         io_beat_bits_tail_0 = (tail_counter == 4'h1 | tail_beats1 == 4'h0) & (is_body | _io_beat_bits_tail_T);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:60:24, :65:{35,47}, :109:{45,69}]
  ...
  always @(posedge clock) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
    if (reset) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
      head_counter <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      tail_counter <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      ...
      if (q_io_deq_ready & _q_io_deq_valid) begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17, :62:35, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        head_counter <= head ? (_q_io_deq_bits_opcode[2] ? 4'h0 : ~(_tail_beats1_decode_T[5:2])) : head_counter - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:37, :221:14, :229:27, :230:28, :231:25, :236:21, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:47:17]
        tail_counter <= tail_counter == 4'h0 ? tail_beats1 : tail_counter - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :230:28, :231:25, :236:21]
      end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
    ...
    initial begin	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
        ...
        head_counter = _RANDOM[/*Zero width*/ 1'b0][3:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
        tail_counter = _RANDOM[/*Zero width*/ 1'b0][7:4];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:108:7]
        is_body = _RANDOM[/*Zero width*/ 1'b0][8];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, generators/testchipip/src/main/scala/serdes/TLChannelCompactor.scala:60:24, :108:7]
      `endif // RANDOMIZE_REG_INIT
    end // initial
