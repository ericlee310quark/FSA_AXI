...
module Queue2_TLBundleA_a15d64s10k1z2u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [9:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [14:0] io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [9:0]  io_deq_bits_source	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);
  ...
  ram_2x15 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_source, io_enq_bits_size, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[4:3];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_source = _ram_ext_R0_data[14:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
