...
module ram_512x13(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [8:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [12:0] R0_data,
  ...
  reg [12:0] Memory[0:511];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [9:0] i = 10'h0; i < 10'h200; i += 10'h1) begin
          ...
          Memory[i[8:0]] = _RANDOM_MEM[12:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
