...
module Queue2_RegMapperOutput(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input         io_enq_bits_extra_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_2x33 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_read})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_read = _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[32:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
